namespace PopLoons {
    ...
    export class LoonBlue extends MovingLoons {//MovingLoons {
        ...
        /*randomPosition
        setRandomPositionL4(): void {
            this.x = Math.random() * crc2.canvas.width;
            this.y = 0;
        }*/
        
        /*Positionscheck
        checkPositionLoonBlue() {
            let PositionX = this.x;
            let PositionY = this.y;
            let loonsBlueFinalPosition = PositionX + PositionY;
            
            return loonsBlueFinalPosition;
            }*/
        ...
        draw(): void {
            ...
            crc2.fillStyle = "rgb(000, 000, 255)";
